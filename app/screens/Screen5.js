...
export default class RowActions1 extends Component {
  ...
  allowDrag () {
    this.setState({allowDrag: !this.state.allloDrag})
   // console.log('hi fron the top')
  }
  render() {
    return (
      <View style={styles.container}>

        <Row checkMe={this.state.allowDrag} update={this.allowDrag} damping={this.state.damping} tension={this.state.tension}>
...
class Row extends Component {
  ...
  onDragEvent (event) {console.log(event.nativeEvent);this.props.update(), console.log(this.props.checkMe)};
  render() {
    return (
      <View style={{backgroundColor: '#de6d77'}}>
        ...
        <Interactable.View
          ...
          dragEnabled={this.props.checkMe}
